...
soi_base <- soi_tornado_5 %>% filter(Mag < 4) %>% select(1, 22:51)
mean(soi_base$Establishments_Nature, na.rm = TRUE)
mean(soi_base$Employment_Nature, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Nature, na.rm = TRUE)

mean(soi_base$Establishments_Construction, na.rm = TRUE)
mean(soi_base$Employment_Construction, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Construction, na.rm = TRUE)

mean(soi_base$Establishments_Manufacturing, na.rm = TRUE)
mean(soi_base$Employment_Manufacturing, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Manufacturing, na.rm = TRUE)

mean(soi_base$Establishments_Finance, na.rm = TRUE)
mean(soi_base$Employment_Finance, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Finance, na.rm = TRUE)

mean(soi_base$Establishments_Professional, na.rm = TRUE)
mean(soi_base$Employment_Professional, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Professional, na.rm = TRUE)

mean(soi_base$Establishments_Educ_Health, na.rm = TRUE)
mean(soi_base$Employment_Educ_Health, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Educ_Health, na.rm = TRUE)

mean(soi_base$Establishments_Educ_Health, na.rm = TRUE)
mean(soi_base$Employment_Educ_Health, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Educ_Health, na.rm = TRUE)

mean(soi_base$Establishments_Hospitality, na.rm = TRUE)
mean(soi_base$Employment_Hospitality, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Hospitality, na.rm = TRUE)

mean(soi_base$Establishments_Other_Services, na.rm = TRUE)
mean(soi_base$Employment_Other_Services, na.rm = TRUE)
mean(soi_base$Weekly_Wage_Other_Services, na.rm = TRUE)
...
soi_tornado_1.0 <- soi_tornado_1 %>% filter(Mag == 0)
mean(soi_tornado_1.0$Inflow, na.rm = TRUE)
mean(soi_tornado_1.0$Outflow, na.rm = TRUE)
mean(soi_tornado_1.0$Netflow, na.rm = TRUE)
soi_tornado_1.0$Grossflow = soi_tornado_1.0$Inflow + soi_tornado_1.0$Outflow
mean(soi_tornado_1.0$Grossflow, na.rm = TRUE)

soi_tornado_4.0 <- soi_tornado_4 %>% filter(Mag == 0)
mean(soi_tornado_4.0$Housing_Med, na.rm = TRUE) # 120314.7
mean(soi_tornado_4.0$Civilian_Labor_Force, na.rm = TRUE) # 48565.99
mean(soi_tornado_4.0$Unemp_Rate, na.rm = TRUE) # 6.18
mean(soi_tornado_4.0$Republican, na.rm = TRUE) # 57.73

soi_tornado_1.0 <- soi_tornado_1 %>% filter(Mag < 5)
mean(soi_tornado_1.0$Inflow, na.rm = TRUE)
mean(soi_tornado_1.0$Outflow, na.rm = TRUE)
mean(soi_tornado_1.0$Netflow, na.rm = TRUE)
soi_tornado_1.0$Grossflow = soi_tornado_1.0$Inflow + soi_tornado_1.0$Outflow
...
soi_tornado_4.0 <- soi_tornado_4 %>% filter(Mag < 5)
mean(soi_tornado_4.0$Housing_Med, na.rm = TRUE) # 120314.7
mean(soi_tornado_4.0$Civilian_Labor_Force, na.rm = TRUE) # 48565.99
mean(soi_tornado_4.0$Unemp_Rate, na.rm = TRUE) # 6.18
mean(soi_tornado_4.0$Republican, na.rm = TRUE) # 57.73
...
mean(ES1$Mag, na.rm = TRUE)





min(ES1$Weekly_Wage_Hospitality, na.rm = TRUE)
max(ES1$Weekly_Wage_Hospitality, na.rm = TRUE)
mean(ES1$Weekly_Wage_Hospitality, na.rm = TRUE)
sd(ES1$Weekly_Wage_Hospitality, na.rm = TRUE)
count <- length(ES1$Weekly_Wage_Hospitality)
